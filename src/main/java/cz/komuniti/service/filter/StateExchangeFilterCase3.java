 ...
 */
//REGION
@Service(value="StateExchangeFilterCase3")
public class StateExchangeFilterCase3 extends StateExchangeFilter{
    ...
    public List<OfferEntity> getResult(ExchangeFilterForm filter, Integer page) {
        return offerManager.findPageActivateRegion(pager.getResult()[0], pager.getResult()[1], Boolean.TRUE, regions);
    }
    ...
    public int getCount(ExchangeFilterForm filter) {
        ...
        return offerManager.getCountActivateRegion(Boolean.TRUE, regions);
    }
