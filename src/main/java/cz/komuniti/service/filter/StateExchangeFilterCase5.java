 ...
 */
//item tags, region
@Service(value="StateExchangeFilterCase5")
public class StateExchangeFilterCase5 extends StateExchangeFilter {
    ...
    public List<OfferEntity> getResult(ExchangeFilterForm filter, Integer page) {
        return offerManager.findPageActivateItemTagRegion(pager.getResult()[0], pager.getResult()[1], Boolean.TRUE, tags, regions);
    }
    ...
    public int getCount(ExchangeFilterForm filter) {
        ...
        return offerManager.getCountActivateItemTagRegion(Boolean.TRUE, tags, regions);
    }
