...
@Component
public class FieldEmailNotInDBValidator implements ConstraintValidator<FieldEmailNotInDB, Object> {
    private String email;
    
    private UserManager userManager;
    
    public void initialize(final FieldEmailNotInDB constrainAnnotation) {
