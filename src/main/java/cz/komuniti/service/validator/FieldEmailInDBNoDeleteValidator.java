 ...
 */
@Component
public class FieldEmailInDBNoDeleteValidator implements ConstraintValidator<FieldEmailInDBNoDelete, Object>{

    private String email;
    
    private UserManager userManager;
    
    public void initialize(final FieldEmailInDBNoDelete constrainAnnotation) {
    ...
    public boolean isValid(final Object value, final ConstraintValidatorContext context) {
        try{
            ...
            UserEntity u = userManager.findByEmailDeleted((String)fieldEmail,Boolean.FALSE);
            return u != null;
        }catch(Exception e){
            ///ignore
        }
