    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="page-header">
                <h2>Přidání nabídky - Přidání vlastního zboží</h2>
                <h4>Nabídka: ${offer.title}</h4>
            </div>

            <form:form action="addItem.htm" method="POST" commandName="addFormModel" enctype="multipart/form-data">
                <div class="row-fluid">
                    <div class="span8">    
                        <form:errors path="*" cssClass="alert alert-error" element="div" />
                        <div class="control-group"> 
                            <form:label path="name" >Název zboží:</form:label>
                            <form:input path="name" id="text_name" />
                            <form:errors path="name" cssClass="alert alert-error" element="div" />
                        </div>
                        <div class="control-group">
                            <form:label path="description" >Popis zboží:</form:label>
                            <form:textarea path="description" cols="50" id="text_description" />
                ...
                <div class="control-group">               
                    <button class="btn btn-primary" id="btn_add_offer_submit">Odeslat</button>
                </div> 
            </form:form>    
        </div>
